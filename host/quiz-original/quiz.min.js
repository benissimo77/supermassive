(function () {
  ...
  */
  ...
  function DOMremovePlayer(sessionID) {
      ...
      if (DOMplayer) {
          gsapWithCSS.killTweensOf(DOMplayer);
          DOMplayer.remove();
      }
  ...
  function TLarrangePlayersInPanelHorizontal(panel) {
      ...
      DOMpanel.offsetHeight / 120;    // don't use scale just keep same size
      const tl = gsapWithCSS.timeline();
  ...
  function TLgameState() {
      ...
      const tl = gsapWithCSS.timeline();
      gsapWithCSS.killTweensOf(".player");
  ...
  function TLupdateScores(scores) {
      ...
      overtakes.forEach( (overtake) => {
          ...
          for (let i=0; i<players.length; i++) {
              ...
              const playertl = gsapWithCSS.timeline();
  ...
  function TLendQuiz() {
      ...
      tl.add( gsapWithCSS.to(document.getElementById(bestPlayerId), { scale: 2 }) );
      return tl;
  }
  ...
  function TLpanelQuestion(question) {
      ...
      const tl = gsapWithCSS.timeline({ onComplete: () => { console.log('timeline.onComplete'); }});
      ...
      tl.add( () => {
          gsapWithCSS.set(questionPanel, { x: 1920 }); 
      ...
      tl.add( gsapWithCSS.to(questionPanel, { x: 0, ease:"back.out(1)" }) );
      ...
      const textTween = gsapWithCSS.to(questionText, { text: {
          value: question.text,
          delimiter: "",
  ...
  function DOMstartTimer(request) {
      ...
      gsapWithCSS.set("#timer", { display: "block" });
      gsapWithCSS.fromTo("#timer .timer_progress", { width: "100%" }, { 
          width: 0,
  ...
  function DOMhideTimer() {
      gsapWithCSS.set("#timer", { display: "none" });
  }
  ...
  function setWindowScale(x, instant=true) {
      console.log('setWindowScale:', x, instant, document.getElementById("body"), gsapWithCSS);
      if (instant) {
          gsapWithCSS.set("#wrapper", { scaleX: x, scaleY: x });
      } else {
          gsapWithCSS.to("#wrapper", { scaleX: x, scaleY: x });
      }
  ...
  function callAfterResize(func, delay) {
      ...
      let dc = gsapWithCSS.delayedCall(delay || 0.2, func).pause(),
  ...
  function init() {
      ...
      gsapWithCSS.to("body", { backgroundColor: "#ffffff" });
      ...
      gsapWithCSS.to("#overlay", { opacity: 0.85, duration: 1 });
  ...
  function screenSizeBody() {
      ...
      gsapWithCSS.set("#playerlist", { top: canvasAdjustY(1040), height: canvasAdjustY(20) } );
      // Not even using any of these anymore... pfff!
      gsapWithCSS.set("#panel-response", { top: canvasAdjustY(90), height: canvasAdjustY(240) } );
      gsapWithCSS.set("#panel-question", { top: canvasAdjustY(90), height: canvasAdjustY(380) } );
      gsapWithCSS.set("#panel-answers", { top: canvasAdjustY(440), height: canvasAdjustY(400) } );

      // This is the only one needed - general purpose question (and options panel)
      gsapWithCSS.set("#question-panel", { top: canvasAdjustY(16), height: canvasAdjustY(940) } );
      gsapWithCSS.set("#information-panel", { y: canvasAdjustY(-1080) });

      gsapWithCSS.set("#racetrack", { y: canvasAdjustY(480), height: canvasAdjustY(400) });
      gsapWithCSS.set("#racetrack-markers", { y: 0, height: canvasAdjustY(24) });
      gsapWithCSS.set("#racetrack-lanes", { y: canvasAdjustY(80), height: canvasAdjustY(600) });

      gsapWithCSS.set("#timer", { top: canvasAdjustY(1000), height: canvasAdjustY(40) } );
      ...
      gsapWithCSS.set("#buttonlist", {
          y: canvasAdjustY(8),
          height: canvasAdjustY(20),
          scale: 1/scaleX,
      } );
      // What is the payloadlist ???
      gsapWithCSS.set("#payloadlist", {
          fontSize: 16 / scaleX,
      });
  ...
  class Quiz {
      ...
      onQuestion = (question) => {
          ...
          gsapWithCSS.killTweensOf("#question-panel");
          dom.TLpanelSlideUp()
