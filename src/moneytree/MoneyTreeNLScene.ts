...
export default class MoneyTreeNLScene extends BaseScene {
    ...
    private questionData1: { questionIndex: number, question: string, answers: string[], correct: number }[] = [
        ...
        {
            "questionIndex": 18,
            "question": "Which Dutch scientist is credited with discovering Saturn's moon Titan?",
            "answers": ["Antonie van Leeuwenhoek", "Christiaan Huygens", "Hugo de Groot"],
            "correct": 1
        },
        {
            "questionIndex": 17,
        ...
        {
            "questionIndex": 15,
            "question": "Which 17th-century Dutch legal scholar is known for laying the foundations of intern. law?",
            "answers": ["Hugo Grotius", "Cornelis de Witt", "Baruch Spinoza"],
            "correct": 0
        },
        {
            "questionIndex": 14,
        ...
        {
            "questionIndex": 12,
            "question": "Which Dutch island used to be part of the mainland before the Zuiderzee was formed?",
            "answers": ["Urk", "Texel", "Schiermonnikoog"],
            "correct": 0
        },
        {
            "questionIndex": 11,
        ...
        {
            "questionIndex": 7,
            "question": "In what year did King Willem-Alexander become king?",
            "answers": ["2011", "2013", "2015"],
            "correct": 1
        },
        {
            "questionIndex": 6,
    ...
    private questionData2 = [
        ...
        {
            "questionIndex": 7,
            "question": "Which Dutch football club has won the most Eredivisie titles as of 2025?",
            "answers": ["Feyenoord", "Ajax", "PSV"],
            "correct": 1
        },
        {
            "questionIndex": 8,
        ...
        {
            "questionIndex": 11,
            "question": "Which city is known for the oldest university in the Netherlands (founded 1575)?",
            "answers": ["Utrecht", "Leiden", "Nijmegen"],
            "correct": 1
        },
        {
            "questionIndex": 12,
        ...
        {
            "questionIndex": 13,
            "question": "Which Dutch poet wrote the line: 'Denkend aan Holland zie ik breede rivieren'?",
            "answers": ["J.C. Bloem", "Hendrik Marsman", "Martinus Nijhoff"],
            "correct": 1
        },
        {
            "questionIndex": 14,
        ...
        {
            "questionIndex": 16,
            "question": "Name the 17th-century mapmaker whose works are still widely reproduced today?",
            "answers": ["Blaeu", "Hondius", "Mercator"],
            "correct": 0
        },
        {
            "questionIndex": 17,
    ...
    private questionData3 = [
        ...
        {
            "questionIndex": 4,
            "question": "What is the longest river flowing through the Netherlands?",
            "answers": ["Meuse (Maas)", "Waal", "Rhine (Rijn)"],
            "correct": 2
        },
        {
            "questionIndex": 5,
        ...
        {
            "questionIndex": 10,
            "question": "Which document limited the power of the monarchy and influenced the Dutch Republic's constitution?",
            "answers": ["Plakkaat van Verlatinghe", "Union of Utrecht", "Treaty of Breda"],
            "correct": 0
        },
        {
            "questionIndex": 11,
        ...
        {
            "questionIndex": 15,
            "question": "What was the name of the Dutch ship that discovered parts of Australia in the 17th century?",
            "answers": ["De Zeven Provinciën", "Duyfken", "Batavia"],
            "correct": 1
        },
        {
            "questionIndex": 16,
        ...
        {
            "questionIndex": 19,
            "question": "Which Dutch mathematician developed early probability theory with Blaise Pascal?",
            "answers": ["Simon Stevin", "Jan de Witt", "Christiaan Huygens"],
            "correct": 1
        },
        {
            "questionIndex": 20,
    ...
    private transitions: Record<MoneyTreeState, MoneyTreeState[]> = {
        ...
        FINAL_CHOICE: [MoneyTreeState.PLAY_SAFE, MoneyTreeState.GAMBLE],
    ...
    splash(): void {
        ...
        const gameData: { questionIndex: number, question: string, answers: string[], correct: number }[][] = [this.questionData1, this.questionData2, this.questionData3];

        const container: Phaser.GameObjects.Container = this.add.container();

        for (let i = 0; i < 3; i++) {
            const gameButton = this.add.text(480 + i * 480, this.getY(120), `Game ${i + 1}`, {
                fontFamily: 'Arial',
                color: '#000090',
    ...
    introRound() {
        ...
        this.safeCashText = this.add.text(1880, this.getY(1020), "CASH: $", {
            fontFamily: 'Arial',
            color: '#cccc00',
            backgroundColor: '#000000',
            padding: { left: 20, right: 20, top: this.getY(8), bottom: this.getY(8) }
        }).setOrigin(1, 0.5)
            .setFontSize(this.getY(60))
            .setVisible(false);
    ...
    finalChoice() {
        ...
        const safeButton = this.add.text(960, minY, "SAFE", {
            fontFamily: 'Arial',
            color: '#000000',
        ...
        const gambleButton = this.add.text(1480, minY, "GAMBLE", {
            fontFamily: 'Arial',
            color: '#000000',
        ...
        introContainer.add([title, instructions, safeButton, gambleButton, this.safeCashText, this.finalEnvelope]);
    ...
    gambleWonMessage(): void {
        ...
        if (moneyWon > (this.safeCash * 2)) {
            ...
            finalText.setText(`You answered the question correctly but only won $${moneyWon}!\n\nYou could have played safe and walked away with $${this.safeCash}...:(\n\nOh well - better luck next time!`);
        }
