...
export default class MultipleChoiceQuestion extends BaseQuestion {
     ...
     * Host only ever displays - player-side interactivity lives in PlayerMultipleChoiceQuestion
     */
    ...
    protected showAnswerContent(answerHeight: number): void {
        ...
        console.log('MultipleChoiceQuestion::showAnswerContent:', this.questionData.mode, availableHeight, buttonSpace);
    ...
    // Host never makes buttons interactive (that's PlayerMultipleChoiceQuestion's job) - kept as
