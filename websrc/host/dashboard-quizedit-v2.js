...
function initDashboardQuizEdit() {
	...
	UI.roundsContainer = document.getElementById('rounds-container');
	UI.quizTitle = document.getElementById('quiz-title');
	UI.quizDescription = document.getElementById('quiz-description');
	UI.quizJson = document.getElementById('quiz-json');
	UI.quizId = document.getElementById('quiz-id');
	UI.quizOwner = document.getElementById('quiz-owner');
	UI.quizSchema = document.getElementById('quiz-schema-version');
	...
	UI.aiPromptInput = document.getElementById('ai-prompt-input');
	...
	UI.pasteJsonPanel = document.getElementById('paste-json-panel');
	UI.pasteJsonInput = document.getElementById('paste-json-input');
	UI.pasteJsonSubmit = document.getElementById('paste-json-submit');
	UI.pasteJsonStatus = document.getElementById('paste-json-status');
...
async function handlePasteJsonImport() {
	...
	if (parsed && typeof parsed === 'object') {
		if (Array.isArray(parsed.rounds)) {
			...
			if (parsed.title) quizData.title = parsed.title;
			if (parsed.description) quizData.description = parsed.description;
			changed = true;
